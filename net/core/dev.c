...
#ifdef CONFIG_TP_IMAGE
	/* merge from:<< Yangyang@31Dec2019, add, bugfix: 332022.
	** refer to https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?h=v3.5&id=62b1a8ab9b3660bb820d8dfe23148ed6cda38574	
	*/
	skb_orphan_try(skb);
	/* >> endof Yangyang@31Dec2019, add, bugfix: 332022. */
...
#if IS_ENABLED(CONFIG_BRIDGE) && (IS_ENABLED(CONFIG_ATM_LANE) || (defined CONFIG_X_TP_VLAN))
